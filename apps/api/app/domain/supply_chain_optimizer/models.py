...
class AgenticSupplyChainOptimizerSession(Base):
    __tablename__ = "supply_chain_optimizer_sessions"
...
class AgenticSupplyChainOptimizerItem(Base):
    __tablename__ = "supply_chain_optimizer_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("supply_chain_optimizer_sessions.id"))
